...
<div class="sistema">
<p>Система отполения и водоснабжения</p>
</div>
<div class="uslugii2">
...
<a href="sistema.php"> <img src="/image/14.png" style="width:350px; height: 400px;" alt=""></a>
	...
	<div class="opisanie">
		<p>	Желание иметь в частном доме все удобства, включая отопление, круглосуточную подачу холодной и горячей воды, должно быть учтено при составлении проекта строения.
			Кроме разводки коммуникаций внутри здания, необходимо предусмотреть подачу воды из внешнего источника.</p>
		<p></p>
		<p>Ремонтируем и настриваем систему отполения в Кемерово.
		<p></p>
		<p>Наши инженеры квалифицированно настроют систему отполения и водоснабжения в правильном ввиде.</p>
		<p></p>
